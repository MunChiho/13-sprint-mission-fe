...
안녕하세요 멘토님 저는 비전공자에 완전 입문자라 아직 많이 부족합니다.
현재 html 구조를 작성 할 때 아직 부족한 부분이 많아 구분을 하는점이 좀 미숙합니다 그부분을 좀 자세히 알고 싶습니다.
css 파일도 현재 완전 이해를 하고 작성을 한 것이 아닌 피그마에서 복사를 한 부분과 이것 저것 만져보면서 작성을 하여 중복이나 정리가 되지 않은점도 있어 그런 점도 알려주시면 열심히 배우겠습니다 감사합니다.
